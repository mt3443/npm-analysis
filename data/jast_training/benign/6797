...
var IconHomeComponent = /** @class */ (function (_super) {
    __extends(IconHomeComponent, _super);
    ...
    Object.defineProperty(IconHomeComponent.prototype, "Height", {
        get: function () {
    ...
    Object.defineProperty(IconHomeComponent.prototype, "Width", {
        get: function () {
