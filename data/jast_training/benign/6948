...
exports.colors = materialColors;
function color(name, variant, prefixHexSymbol) {
    if (variant === void 0) { variant = '500'; }
    if (prefixHexSymbol === void 0) { prefixHexSymbol = true; }
    if (typeof exports.colors[name] === 'object' && typeof exports.colors[name][variant] === 'string') {
        return prefixHexSymbol ? exports.colors[name][variant] : exports.colors[name][variant].replace('#', '');
    }
