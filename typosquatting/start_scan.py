...
os.system('mv /dev/shm/npm/typosquatting/typosquatting_positives.csv /users/m139t745/npm-analysis/output/positive/{}'.format(node))
os.system('mv /dev/shm/npm/typosquatting/typosquatting_negatives.csv /users/m139t745/npm-analysis/output/negative/{}'.format(node))
os.system('rm -rf /dev/shm/npm')
