...
function scan_packages(packages) {
    ...
    for (let package of packages) {
        let result = run_tests(package);

        if (result != null) {
            prompt_user = true;
            console.log('Warning! "' + package + '" may be typosquatting. Did you mean to type "' + result + '"?');
        }
    }

    if (prompt_user) {
        let response = readline_sync.question('Are you sure you want to install these packages? [Y/n] ');
